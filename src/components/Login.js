  ...
  return (
    <div>
        ...
        {isSignedInForm ? "Sign In" : "Sign Up"}
          ...
          {!isSignedInForm && <input type="text"
          ...
          className="p-4 my-4 w-full bg-gray-700"></input>
          <button   className="p-4 my-6 bg-red-700 w-full rounded-lg" >{isSignedInForm ? "SignIn" : "SignUp"}</button>
          <p className="py-4 cursor-pointer" onClick={toggleSignInForm}>{isSignedInForm ? "New to Netflix? Sign up now." : "Already registered? Sign In Now."} </p>
        </form>
    </div>
